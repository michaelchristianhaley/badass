...
5. **Use the outline and map.** Read the active outline, follow the user-controlled inspection map, and trigger a full repository read when a gate requires it.
